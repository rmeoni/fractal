...
<div class="featuring" id="home-featuring">
	...
	<div class="row">
		...
		<div class="col-md-6 col-xs-12">
			...
			<p>Cosecha 2022, café tostado y molido el {{ site.time | date: '%d/%m/%y' }}, elaborado con los más finos estandares de calidad y los mejores cuidados para que usted experimente un café aromático, con una intensidad media y un cuerpo robusto. </p>
